...
@Mod(StuffAndStuff.MOD_ID)
public class StuffAndStuff {
    // Define mod id in a common place for everything to reference
    public static final String MOD_ID = "stuffandstuff";
    // Directly reference a slf4j logger
    public static final Logger LOGGER = LogUtils.getLogger();



    public StuffAndStuff(FMLJavaModLoadingContext context) {
